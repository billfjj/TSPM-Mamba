...
weights_name = (str(bool(crop_size)) + '-' + str(image_size) + "-e" + str(max_epoch) +
                "-" + extract_model_name + "-" + "d8" + "-" + current_time)
weights_path = f"model_weights/camvid/TSP2Mamba/{weights_name}"
...
pretrained_ckpt_path = None  # the path for the pretrained ossfmmamba weight
