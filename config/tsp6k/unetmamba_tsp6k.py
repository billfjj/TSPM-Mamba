...
from tsp2mamba_model.models.UNetMamba import UNetMamba
...
weights_name = ("unetmamba-tsp6k-" + str(image_size) + "-e" + str(max_epoch) + "-" +
                extract_model_name + "-" + now.strftime("%Y%m%d%H%M"))
